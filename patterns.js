...
const days = `monday|tuesday|wednesday|thursday|friday|saturday|sunday|mon|tue|tues|wed|thur|thurs|fri|sat|sun|montag|dienstag|mittwoch|donnerstag|freitag|samstag|sonntag|mo|di|mi|do|fr|sa|so|понедельник|вторник|среда|четверг|пятница|суббота|воскресенье|понеділок|вівторок|п${apos}ятниця|субота|неділя|пн|вт|ср|чт|пт|сб|вс|нд`
const months = `(?:january|february|march|april|may|june|july|august|september|october|november|december|enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|januar|februar|märz|mai|juni|juli|oktober|dezember|jan\\.?|ene\\.?|feb\\.?|mar\\.?|apr\\.?|abr\\.?|may\\.?|jun\\.?|jul\\.?|aug\\.?|ago\\.?|sep\\.?|sept\\.?|oct\\.?|nov\\.?|dec\\.?|dic\\.?|январ|феврал|март|апрел|июн|июл|август|сентябр|октябр|декабр|янв\\.?|фев\\.?|мар\\.?|апр\\.?|май\\.?|июн\\.?|июл\\.?|авг\\.?|сен\\.?|окт\\.?|ноя\\.?|дек\\.?|січе?н|лют|березе?н|квіте?н|траве?н|черве?н|липе?н|серпе?н|вересе?н|жовте?н|листопад|груде?н|січ\\.?|лют\\.?|бер\\.?|кві\\.?|тра\\.?|чер\\.?|лип\\.?|сер\\.?|вер\\.?|жов\\.?|лис\\.?|гру\\.?)(?:ь|я|ого|им|ем|а)?`
const relativeDays = `(?:heute|morgen|übermorgen|gestern|vorgestern|сьогодні|сегодня|(?:п[оі]сл[ея])?завтра|(?:поза)?вчера|today|tomorrow|yesterday|the day before yesterday|the day after tomorrow)(?![a-zа-яєїґ])`
const timeIntervals = `jahre?|monate?|wochen?|tage?|stunden?|minuten?|sekunden?|years?|months?|weeks?|days?|hours?|minutes?|seconds?|год|рік|м[еі]сяц|недел|тиж(?:де)?н|де?н[я]|час|годин|минут|хвилин|секунд`
const positionalTokensAfter = `ago|ahead|prior|zurück|vor|(?:тому )?назад|вперед`
const positionalTokensBefore = `in|durch|через|(?:наступн|попередн|следующ|предыдущ)(?:ий|ого|ем|им|е|а|ая)`
...
const extraTokens = 'due|by|on|during|standard|daylight|savings|time|date|dated|of|to|through|between|until|at|day|am|bis|von|дня|вечера|в|о|від|до|от'
...
const verbalNumbers = `one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|eins|zwei|drei|vier|fünf|sechs|sieben|acht|neun|zehn|elf|zwölf|dreizehn|vierzehn|fünfzehn|sechzehn|siebzehn|achtzehn|neunzehn|(?:оди?н|дв[аіе]?|три?|ч[ео]т[ыи]р|п.?ят|ш[еі]ст|с(?:[еі]|ьо)м|в[оі]с[еь]м|дев.?ят|десят|один+адц[ая]т|дв[еа]н+адцат|тринадц[ая]т|ч[ео]т[ыи]рнадц[ая]т|п.?ятнадцат|ш[еі]стнадц[ая]т|с[іе]мнадц[ая]т|в[оі]с[іе]мнадц[ая]т|дев.?ятнадц[ая]т)(?:${digitsSuffixes})?`
const teens = `(?:twenty|thirty|fourty|fifty|sixty|seventy|eighty|ninety|hundred|zwanzig|dreißig|vierzig|fünfzig|sechzig|siebzig|achtzig|neunzig|hundert|двадц[ая]т|тридц[ая]т|сорок|п.?ятдесят|ш[іе]сть?десят|с[еі]мь?десят|в[оі]семьдесят|дев.?яност|сто|дв[еі]ст|трист|ч[ео]т[ыи]рест|п.?ятсот|ш[іе]сть?сот|с[еі]мь?сот|в[оі]с[еі]мь?сот|дев.*ять*сот)${digitsSuffixes}?`
