const months = {
  '1': /^(?:jan|ene|янв|січ)/gi,
  '2': /^(?:feb|фев|лют)/gi,
  '3': /^(?:mar|mär|мар|бер)/gi,
  '4': /^(?:a[pb]r|апр|кві)/gi,
  '5': /^(?:may|mai|май|тра)/gi,
  '6': /^(?:jun|juni|июн|чер)/gi,
  '7': /^(?:jul|juli|июл|лип)/gi,
  '8': /^(?:aug|ago|авг|сер)/gi,
  '9': /^(?:sep|sept|сен|вер)/gi,
  '10': /^(?:o[ck]t|окт|жов)/gi,
  '11': /^(?:nov|ноя|лис)/gi,
  '12': /^(?:d[ei][cz]|дек|гру)/gi
}
